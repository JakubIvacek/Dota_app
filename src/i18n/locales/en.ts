const en = {
  ...
  home: {
    ...
    suggestedPlayers: 'Players to explore',
    suggestedPlayersDesc: "New here? Check out a few pro players' profiles to see what the app can show.",
    favorites: 'Favorites',
  ...
  matchDetail: {
    ...
    itemPurchaseTooltip: '{item} bought at {time}',
