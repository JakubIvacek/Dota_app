const en = {
  ...
  matchDetail: {
    ...
    skillBuildUnavailable: 'No skill build data for this team.',
    skillCardAbility: 'ABILITY',
    skillCardDamageType: 'DAMAGE TYPE',
    skillCardPierces: 'PIERCES SPELL IMMUNITY',
    skillCardDispellable: 'DISPELLABLE',
    skillCardMana: 'Mana',
